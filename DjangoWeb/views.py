...
#     return render(request, "individual_report.html")  
...
#     # Use predefined office location (used for all approved manual requests)
#     office_location = Location.objects.filter(name__iexact="officeCam").first()
...
#             'location': office_location  # ✅ assign valid HR location
#         }
#     )
